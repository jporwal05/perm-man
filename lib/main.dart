...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<PermissionData> _permissionData = [
    ...
    PermissionData(name: 'CONTACTS', permission: 'android.permission.READ_CONTACTS'),
    PermissionData(name: 'PHONE', permission: 'android.permission.READ_PHONE_STATE'),
    PermissionData(name: 'SMS', permission: 'android.permission.READ_SMS'),
